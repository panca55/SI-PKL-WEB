...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin/corporation.store') }}" autocomplete="off"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="quota" name="quota"
                            placeholder="masukan maksimal quota siswa" required value="{{ old('quota') }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="time" class="form-control" id="jam_berakhir" name="jam_berakhir" placeholder=""
                            required value="{{ old('jam_berakhir') }}" />
                    </div>
                </div>
