...
@section('content')
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Tambah Data Instruktur</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin/instructor.store') }}" autocomplete="off"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="select2 form-select" id="exampleFormControlSelect1"
                            aria-label="Default select example" name="corporation_id">
                            <option selected>Pilih</option>
