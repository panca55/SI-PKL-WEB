...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('corporation/bursa.update', $job->id) }}" autocomplete="off"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Masukan Deskripsi">{{ $job->deskripsi }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="persyaratan" id="persyaratan" placeholder="Masukan Persyaratan">{{ $job->persyaratan }}</textarea>
                    </div>
                </div>
                        ...
                        @foreach ($works as $work)
                            <div class="form-check">
                                <input name="jenis_pekerjaan" class="form-check-input" type="radio"
                                    ...
                                    @if ($job->jenis_pekerjaan === $work) checked @endif />
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="rentang_gaji" name="rentang_gaji"
                            placeholder="masukan tanpa Rp" required value="{{ $job->rentang_gaji }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="batas_pengiriman" name="batas_pengiriman"
                            placeholder="" required value="{{ $job->batas_pengiriman }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="contact_email" name="contact_email" placeholder=""
                            required value="{{ $job->contact_email }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="oldImage" value="{{ $job->foto }}">
                        @if ($job->foto)
                            <img src="{{ asset('storage/public/foto-bursa-kerja/' . $job->foto) }}"
