...
@section('content')
    <div class="card p-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Penilaian Akhir Siswa</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('teacher/evaluation.update', $evaluation->id) }}" autocomplete="off">
                @method('PUT')
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="monitoring" id="monitoring" min="0" max="100"
                            class="form-control" value="{{ $evaluation->monitoring }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="sertifikat" id="sertifikat" min="0" max="100"
                            class="form-control" value="{{ $evaluation->sertifikat }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="logbook" id="logbook" min="0" max="100"
                            class="form-control" value="{{ $evaluation->logbook }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="presentasi" id="presentasi" min="0" max="100"
                            class="form-control" value="{{ $evaluation->presentasi }}" />
                    </div>
                </div>
