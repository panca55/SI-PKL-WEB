        ...
        <div class="card-body pt-12">
            ...
            <form method="POST" action="{{ route('teacher/profile.update', $user->id) }}" enctype="multipart/form-data"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="golongan" name="golongan">
                        ...
                        @foreach ($golonganPNS as $golongan)
                            <option value="{{ $golongan }}" {{ $profile->golongan === $golongan ? 'selected' : '' }}>
                                {{ $golongan }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="bidang_studi" name="bidang_studi" placeholder="" required
                        value="{{ $profile->bidang_studi }}" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pendidikan_terakhir" name="pendidikan_terakhir"
                        placeholder="" required value="{{ $profile->pendidikan_terakhir }}" />
                ...
                <div class="mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        @if ($profile->foto)
                            <img src="{{ asset('storage/public/teachers-images/' . $profile->foto) }}"
