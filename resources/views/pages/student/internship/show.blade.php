    ...
    <div class="container my-5">
        <div class="card mx-auto" style="max-width: 800px;">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('student/internship.index') }}" class="btn btn-light">Kembali</a>
            </div>
            <div class="card-body mt-2">
                ...
                <div class="row">
                    <div class="col-md-4"><strong>Foto Kegiatan / Hasil Pekerjaan</strong></div>
                    <div class="col-md-8">
                        @if ($logbook->foto_kegiatan)
                            <img src="{{ asset('storage/public/foto-kegiatan/' . $logbook->foto_kegiatan) }}"
                                class="img-fluid rounded" alt="Foto Kegiatan" width="200" height="200"
